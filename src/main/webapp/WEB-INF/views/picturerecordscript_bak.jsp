...
//点击操作处理
    $("#touchbtn").click(function (){
      if(scriptid==""){
        ...
        img.onload = function(){
            // var pattern = oldcontext.createPattern(img, "no-repeat");
            // oldcontext.fillStyle = pattern;
            // oldcontext.fillRect(0, 0, oldcanvas.width,oldcanvas.height);
        ...
        if ( $("#script").find("tr").length == 0 ) {
            ...
            //scriptnumber = $("#script").find("tr").length ;
            var trId = $("#script").find("tr").last().attr("id");
            trId = trId.substring(8);
            scriptnumber = trId;
        }
        ...
        btnclip.onclick = function (){
            $("#scripttd"+scriptnumber).append("<td colspan='3'><canvas id='nowcanvas"+scriptnumber+"' width='"+w+"' height='"+h+"' ></td><td><button id='del"+scriptnumber+"' onclick='delscript("+scriptnumber+");'>删除</button></td> ");
        ...
        btnclip.onclick = function (){
            ...
            if(optype =="2"){
                ...
                if(swipenumber=="0"){
                    ...
                    $("#scripttd"+scriptnumber).append("<td><canvas id='nowcanvas"+scriptnumber+"-1' width='"+w+"' height='"+h+"' ></td><td><button id='del"+scriptnumber+"-1' onclick='delscript("+scriptnumber+");'>删除</button></td>");
    ...
    $("#trueassertbtn").click(function (){
     ...
     if(scriptid==""){
        ...
        btnclip.onclick = function (){
            if(optype =="1"||optype=="3"||optype=="4"){
                $("#scripttd"+scriptnumber).append("<td colspan='2'><canvas id='nowcanvas"+scriptnumber+"' width='"+w+"' height='"+h+"' ></td><td><button id='del"+scriptnumber+"' onclick='delscript("+scriptnumber+");'>删除</button></td> ");
                nowcanvas = document.getElementById("nowcanvas"+scriptnumber);
                nowcontext = nowcanvas.getContext('2d');
                imgCut(nowcontext,img,oldcanvas.width,oldcanvas.height,startPoint.x,startPoint.y,w,h);
                picname = Date.now();
      ...
      if(scriptid==""){
        ...
        btnclip.onclick = function (){
            if(optype =="1"||optype=="3"||optype=="4"||optype=="5"){
                $("#scripttd"+scriptnumber).append("<td><canvas id='nowcanvas"+scriptnumber+"' width='"+w+"' height='"+h+"' ></td><td colspan='2'><input id='waitsecond"+scriptnumber+"' onBlur='waitblur("+scriptnumber+")' autofocus='autofocus'>秒</td><td><button id='del"+scriptnumber+"' onclick='delscript("+scriptnumber+");'>删除</button></td> ");
                nowcanvas = document.getElementById("nowcanvas"+scriptnumber);
                nowcontext = nowcanvas.getContext('2d');
                imgCut(nowcontext,img,oldcanvas.width,oldcanvas.height,startPoint.x,startPoint.y,w,h);
                picname = Date.now();
    ...
    $("#inputbtn").click(function (){
      if(scriptid==""){
        ...
        scriptnumber = parseInt(scriptnumber)+1;
        $("#script").append("<tr id='scripttd"+scriptnumber+"'><td>输入文本</td><td colspan='3'><input id='inputtext"+scriptnumber+"'  autofocus='autofocus' onBlur='inputblur("+scriptnumber+")'></td><td><button id='del"+scriptnumber+"' onclick='delscript("+scriptnumber+");'>删除</button></td></tr>");
      ...
      $("#sleepbtn").click(function (){
        if(scriptid==""){
            ...
            scriptnumber = parseInt(scriptnumber)+1;
            $("#script").append("<tr id='scripttd"+scriptnumber+"'><td>睡眠</td><td colspan='3'><input id='sleepsecond"+scriptnumber+"' autofocus='autofocus' onBlur='sleepblur("+scriptnumber+")'>秒</td><td><button id='del"+scriptnumber+"' onclick='delscript("+scriptnumber+");'>删除</button></td></tr>");
            sleepscript = "sleep(";
      ...
      $("#snapshotbtn").click(function(){
          if(scriptid==""){
            ...
            scriptnumber = parseInt(scriptnumber)+1;
            $("#script").append("<tr id='scripttd"+scriptnumber+"'><td>截图操作</td><td colspan='4'><button id='del"+scriptnumber+"' onclick='delscript("+scriptnumber+");'>删除</button></td></tr>");
